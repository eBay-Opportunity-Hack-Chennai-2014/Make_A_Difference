...
import com.makedifference.ReportLowCreditUser.getRegister;
import com.makedifference.Json.APIConnection;

public class ReportLowCreditUser extends Activity implements OnClickListener {
	...
	public class getRegister extends AsyncTask<Void, Void, String> {
		SharedPreferences preferences = PreferenceManager
				.getDefaultSharedPreferences(ReportLowCreditUser.this);
		/*
		 * String url =
		...
		String url="http://makeadiff.in/madapp/index.php/api/report_low_credit_user?city_id=1&key="+ preferences.getString("key", "");
...
*/
		...
		protected void onPostExecute(String result) {
			...
			if (result.equals("")) {
				Utility.showAlertDialog(ReportLowCreditUser.this, "Error",
		...
		protected void onPreExecute() {
			...
			dialog = ProgressDialog
					.show(ReportLowCreditUser.this, "Loading", "", true);
		...
		protected String doInBackground(Void... params) {
			...
			if (Utility.isNetworkAvailable(ReportLowCreditUser.this)) {
	...
	private void loginMethod(String result) {
		...
		try {
			...
			Creditadapter adapter = new Creditadapter(ReportLowCreditUser.this, classstatus,classtime,classchange,1,R.drawable.reports);
