...
import com.makedifference.VolutantaryDb.getRegister;
...
public class VolutantaryDb extends Activity implements OnClickListener {
	...
	public class getRegister extends AsyncTask<Void, Void, String> {
		SharedPreferences preferences = PreferenceManager
				.getDefaultSharedPreferences(VolutantaryDb.this);
		/*
		 * String url =
		...
		String url="http://makeadiff.in/madapp/index.php/api/user_get_all?city_id=10&key="+ preferences.getString("key", "");
		...
		protected void onPostExecute(String result) {
			...
			if (result.equals("")) {
				Utility.showAlertDialog(VolutantaryDb.this, "Error",
		...
		protected void onPreExecute() {
			...
			dialog = ProgressDialog
					.show(VolutantaryDb.this, "Loading", "", true);
		...
		protected String doInBackground(Void... params) {
			...
			if (Utility.isNetworkAvailable(VolutantaryDb.this)) {
	...
	private void loginMethod(String result) {
		...
		try {
			...
			for (int i = 0; i < jsonobjtaecher.length(); i++) {
				...
				classtime.add("Email :"+jsonobjtaecher.getJSONObject(i).getString(
						"email"));
				classchange.add("Phone :"+jsonobjtaecher.getJSONObject(i)
						.getString("phone"));
			...
			Creditadapter adapter = new Creditadapter(VolutantaryDb.this, classstatus,classtime,classchange,1,R.drawable.voluntary);
