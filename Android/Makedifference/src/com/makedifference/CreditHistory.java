...
import com.makedifference.Atteancelist.getRegister;
...
public class CreditHistory extends Activity implements OnClickListener {
	...
	public class getRegister extends AsyncTask<Void, Void, String> {
		SharedPreferences preferences = PreferenceManager
				.getDefaultSharedPreferences(CreditHistory.this);
		/*
		 * String url =
		...
		String url="http://makeadiff.in/madapp/index.php/api/user_credit_history?user_id=1&key="+ preferences.getString("key", "");
...
*/
		...
		protected void onPostExecute(String result) {
			...
			if (result.equals("")) {
				Utility.showAlertDialog(CreditHistory.this, "Error",
		...
		protected void onPreExecute() {
			...
			dialog = ProgressDialog
					.show(CreditHistory.this, "Loading", "", true);
		...
		protected String doInBackground(Void... params) {
			...
			if (Utility.isNetworkAvailable(CreditHistory.this)) {
	...
	private void loginMethod(String result) {
		...
		try {
			...
			for (int i = 0; i < jsonobjtaecher.length(); i++) {
				...
				classtime.add("Credit time :"+jsonobjtaecher.getJSONObject(i).getString(
						"class_time"));
				classchange.add("Credit Change :"+jsonobjtaecher.getJSONObject(i)
						.getString("credit_change"));
				
				classstatus.add("Credit Status :"+jsonobjtaecher.getJSONObject(i)
			...
			Creditadapter adapter = new Creditadapter(CreditHistory.this, classstatus,classtime,classchange,1,R.drawable.credithistory);
