...
import com.makedifference.ReportCreditLeaderboard.getRegister;
import com.makedifference.Json.APIConnection;

public class ReportCreditLeaderboard extends Activity implements OnClickListener {
	...
	public class getRegister extends AsyncTask<Void, Void, String> {
		SharedPreferences preferences = PreferenceManager
				.getDefaultSharedPreferences(ReportCreditLeaderboard.this);
		/*
		 * String url =
		...
		String url="http://makeadiff.in/madapp/index.php/api/report_credit_leaderboard?city_id=1&key="+ preferences.getString("key", "");
...
*/
		...
		protected void onPostExecute(String result) {
			...
			if (result.equals("")) {
				Utility.showAlertDialog(ReportCreditLeaderboard.this, "Error",
		...
		protected void onPreExecute() {
			...
			dialog = ProgressDialog
					.show(ReportCreditLeaderboard.this, "Loading", "", true);
		...
		protected String doInBackground(Void... params) {
			...
			if (Utility.isNetworkAvailable(ReportCreditLeaderboard.this)) {
	...
	private void loginMethod(String result) {
		...
		try {
			...
			for (int i = 0; i < jsonobjtaecher.length(); i++) {
				...
				classtime.add("Credit :"+jsonobjtaecher.getJSONObject(i).getString(
						"credit"));
				classchange.add("");
			...
			Creditadapter adapter = new Creditadapter(ReportCreditLeaderboard.this, classstatus,classtime,classchange,1,R.drawable.reports);
